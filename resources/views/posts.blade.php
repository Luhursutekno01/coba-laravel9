...
@section('container')
    ...
    <div class="container-fluid row mb-3 justify-content-center">
        <div class="col-md-6">
            <form action="/posts">
                @if (request('category'))
    ...
    @if ($posts->count())
        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                    <img src="{{ asset('storage/' .$posts[0]->image) }}" alt="{{ $posts[0]->category->name }}" class="img-fluid" style="height: 400px;overflow:hidden;">
            @else
            ...
            <div class="card-body text-center">
                ...
                <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary shadow">Read More</a>
            </div>
        </div>
