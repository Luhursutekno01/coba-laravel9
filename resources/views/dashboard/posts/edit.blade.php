...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data" class="mb-5">
            ...
            <div class="mb-3">
              <label for="category_id" class="form-label">Body</label>
            ...
            <div class="mb-3">
                ...
                @enderror
                <textarea name="body" id="editor" class="form-control @error('body') is-invalid @enderror" cols="30" rows="10">{{ old('body', $post->body) }}</textarea>
            </div>
